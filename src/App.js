...
const App = () => {
  ...
  return (
    <div className="App">
      <GalleryOverlay gallery={gallery} index={galleryIndex} setGallery={setGallery} projects={projects} />
      ...
      <Projects projects={projects} setVideo={setVideo} setGalleryIndex={setGalleryIndex} setGallery={setGallery} />
      <About />
    </div>
  );
};
